    ...
    <AuthFormWrapper title="Login">
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="flex items-center justify-between text-sm">
          ...
          <Link href="/auth/forgot-password" className="text-blue-600 hover:text-blue-800 font-semibold">
            Forgot Password?
          </Link>
        </div>
        ...
        <div className="space-y-2">
          <div className="flex items-center space-x-3">
            ...
            <span className="font-mono text-lg font-bold text-gray-900 bg-gray-100 px-3 py-1.5 rounded">
              {DEFAULT_CAPTCHA}
            </span>
          </div>
          <input
